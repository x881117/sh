...
update_lavad(){
    ...
    echo "比如最新版本是 V2.01 就在下方输入V2.01"
    read -p "请输入最新版本(比如V2.01):" release
...
echo && echo -e " ${Red_font_prefix}Lava Network 风男LAVA节点一键脚本${Font_color_suffix} by \033[1;35mLattice\033[0m
 ———————————————————————
